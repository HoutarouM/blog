...
<div class="main-content register">
    ...
    <!-- TODO: add style for register form -->

        <form action="" method="post">
            <input type="text" placeholder="Enter login" name="login" require><br>
            <input type="text" placeholder="Enter email" name="email" require><br>
            <input type="password" placeholder="Enter password" name="pass" require><br>
            <input type="password" placeholder="Repeate password" name="r_pass" require><br>
